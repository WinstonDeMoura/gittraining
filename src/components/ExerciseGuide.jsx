...
const exercises = [
  ...
  },
  {
    ...
    steps: [
      ...
      'No painel "📄 Arquivo do projeto" abaixo, edite o campo "Changelog" e clique em "Salvar alteração".',
      'Revise a alteração pendente: git status',
      'git commit -m "feat: adiciona entrada de [seu nome] no changelog"',
      'git push -u origin feature/minha-entrada',
      'No fluxo real, o próximo passo seria abrir um Pull Request no GitHub — aqui o push já é a etapa final do exercício simulado.',
    ],
  },
  {
    id: 'ex2',
    ...
    steps: [
      'Este cenário já simula "dois colegas": sua-branch e main editaram o mesmo campo "quote" de formas diferentes.',
      'Compare as duas versões: git checkout main, veja o campo no painel "Arquivo do projeto", depois git checkout sua-branch.',
      'Na sua-branch, tente juntar as duas histórias: git merge main',
      'O terminal marca o conflito com <<<<<<< / ======= / >>>>>>> no campo "quote".',
      'Resolva o campo em conflito: resolve quote ours (mantém a sua versão), resolve quote theirs (usa a da main), ou resolve quote "um texto novo" (mistura as duas).',
      'Finalize o merge: git commit',
      'git push',
    ],
  },
  {
    ...
    steps: [
      'Comece uma alteração qualquer no painel "📄 Arquivo do projeto" (ex: mude o campo "Status do sprint") e NÃO finalize o commit.',
